...
object CRC16 {
    ...
    fun crc16(bytes: ByteArray, off: Int, len: Int): Int {
        var crc = 0x0000
        val end = off + len
    ...
    private fun doCrc(b: Byte, crc: Int): Int {
        val index = ((crc ushr 8) xor (b.toInt() and 0xFF)) and 0xFF
        return (crc shl 8) xor LOOKUP_TABLE[index]
    }
}
